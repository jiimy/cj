  ...
  <div class="oil">
    ...
    <section class="special-event">
      <div class="wrapper">
        ...
        <ul class="date">
          ...
          <li><span>당첨자 발표</span> 2020년 9월 21일</li>
        </ul>
        <div class="card-wrap">
          <div class="card left">
          ...
          <div class="card right">
            <div class="title"><span>영상 투표 이벤트 선물</span></div>
            <ul class="item">
              <li class="one">
                <div class="img"></div>
                <div class="text">
                  <strong>LG 무선청소기</strong>
                  코드제로 A9 (1명)
                </div>
              </li>
              <li class="two">
                ...
                <div class="text">
                  <strong>발뮤다</strong>
                  더 토스터 (3명)
                  <span class="comment">※ 색상랜덤</span>
                </div>
              </li>
              <li class="three">
                <div class="img"></div>
                <div class="text">
                  <strong>백설 고소함 가득 참기름</strong>
                  선물세트 2호 (40명)
                </div>
              </li>
            </ul>
    ...
    <footer class="footer">
      <div class="wrapper">
        ...
        <p>&copy;2019 CJ CHEILJEDANG CORP. ALL RIGHTS RESERVED</p>
          ...
          <div class="content">
            <div class="agree1 agree">
              ...
              <div class="detail-wrap">
                <p class="tit">[수집 항목]</p>
                <p class="txt">이름, 휴대폰번호, 주소</p>
                <p class="tit">[수집 및 이용목적]</p>
                <p class="txt">본인 확인 및 무분별한 중복 참여 신청 방지, 당첨자 선정, 백설 고소함 가득 참기름 이벤트 관련 안내</p>
                <p class="tit">[이용 및 보유기간]</p>
                <p class="txt">이벤트 진행 후 3개월이 지난 후 즉시 파기</p>
                <p class="tit">[동의 거부권 및 불이익]</p>
                <p class="txt">이용자는 본인의 개인정보 수집 및 이용에 관한 동의를 거부할 권리가 있습니다. 
                  선택항목의 수집 및 이용에 관한 동의를 거부하는 경우 백설 오일 퀴즈 이벤트 경품 제공 등의 서비스가 제한될 수 있습니다.</p>
              </div>
            </div>
            <div class="agree2 agree">
              <label for="agree2">
                <input type="checkbox" name="agree" id="agree2">
                <span class="chk"></span>
                <span>고객정보 취급 및 위탁 동의(필수)</span>
              </label>
              <button class="btn-detail"></button>
              <div class="detail-wrap">
                <p class="tit">[제공 항목]</p>
                ...
                <p class="txt">㈜더썸컴퍼니</p>
                <p class="tit">[제공 목적]</p>
                <p class="txt">당첨자 선정을 위한 데이터베이스 관리, 백설 이벤트 진행 안내</p>
                <p class="tit">[제공 정보 이용 및 보유기간]</p>
                <p class="txt">이벤트 진행 후 3개월이 지난 후 즉시 파기</p>
                <p class="tit">[위탁업체]</p>
                <p class="txt">이지배송</p>
                <p class="tit">[위탁업무내용]</p>
                <p class="txt">이벤트 대행 및 사은품 배송 업무</p>
                <p class="tit">[동의 거부권 및 불이익]</p>
                <p class="txt">이용자는 본인의 개인정보 제공에 대한 동의를 거부할 권리가 있습니다. 
                  선택항목 제공에 대한 동의를 거부하는 경우 백설 오일 퀴즈 이벤트 경품 제공 등의 서비스가 제한될 수 있습니다.</p>
              </div>
            </div>
            <div class="input-area">
          ...
          <div class="content">
            ...
            <div class="list">
              ...
              <ul>
                ...
                <li><span>
                  사각어묵, 표고버섯, 양파는 채썬 뒤 참기름을 두른 팬에서 각각 볶아 준비한다. <br>
                    ※ 백설 소불고기 양념장 1.5T~2T를 넣고 볶아주세요!
                </span>
                </li>
                <li><span>시금치는 끓는 물에 살짝 데친 뒤 물기 제거하고 소금(약간), 참기름(1.5T)를 넣고 버무려 준비한다. </span></li>
                <li><span>잡채용 돼지고기는 백설 소불고기양념장(2T)(를 넣고 10분간 재운 뒤 팬에서 볶아 준비한다.</span></li>
    ...
    <!-- 다시 생각해보세요 -->
    <div class="popup false-answer type1">
      <div class="popup__inner">
        <div class="popup__wrap">
          <div class="close-btn"></div>
          <div class="img"></div>

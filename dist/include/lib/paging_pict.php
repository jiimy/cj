...
class YsPaging {
	...
	*/
	function getFirstPage() {
		...
		return '<a href="#" onclick="go_page(1);return false;" class="first"><img src="/img/btn_pagination01.gif" alt="처음" /></a>';
	}
	...
	*/
	function getLastPage() {
		...
		return '<a href="#" onclick="go_page('.$this->mPageCount.');return false;" class="last"><img src="/img/btn_pagination04.gif" alt="끝" /></a>';
	}
	...
	*/
	function getPrevPage() {
		if($this->mCurPageNum > 1)
			...
			return '<a href="#" onclick="go_page('.($this->mCurPageNum-1).');return false;" class="prev"><img src="/img/btn_pagination02.gif" alt="이전" /></a>';
		else
	...
	*/
	function getNextPage() {
		if($this->mCurPageNum != $this->mPageCount && $this->mPageCount)
			...
			return '<a href="#" onclick="go_page('.($this->mCurPageNum+1).');return false;" class="next"><img src="/img/btn_pagination03.gif" alt="다음" /></a>';
		else

...
class YsPaging {
	...
	*/
	function getFirstPage() {
		...
		return '<a href="#" onclick="go_page(1);return false;" class="img first"><img src="/img/btn_pagination01.gif" class="w" alt="처음" /><img src="./img/btn_pagination01_m.png" class="m" alt="처음" /></a>';
	}
	...
	*/
	function getLastPage() {
		...
		return '<a href="#" onclick="go_page('.$this->mPageCount.');return false;" class="img last"><img src="./img/btn_pagination04.gif" class="w" alt="끝" /><img src="./img/btn_pagination04_m.png" class="m" alt="끝" /></a>';
	}
	...
	*/
	function getPrevPage() {
		if($this->mCurPageNum > 1)
			...
			return '<a href="#" onclick="go_page('.($this->mCurPageNum-1).');return false;" class="img prev"><img src="./img/btn_pagination02.gif" class="w" alt="이전" /><img src="./img/btn_pagination02_m.png" class="m" alt="이전" /></a>';
		else
	...
	*/
	function getNextPage() {
		if($this->mCurPageNum != $this->mPageCount && $this->mPageCount)
			...
			return '<a href="#" onclick="go_page('.($this->mCurPageNum+1).');return false;" class="img next"><img src="./img/btn_pagination03.gif" class="w" alt="다음" /><img src="./img/btn_pagination03_m.png" class="m" alt="다음" /></a>';
		else
		...
		for($i=$this->mFirstPerPage+1;$i<=$this->mLastPerPage;$i++) {
			if($this->mCurPageNum == $i)
				...
				if(empty($this->mPageCss)) 
					//$rtn .= ''.$i.'</a></li> ';
					$rtn .= '<a href="#" onclick="go_page('.$i.$this->mExtraVar.');return false;">'.$i.'</a> ';
				else
					$rtn .= '<li><a href="#" onclick="go_page('.$i.$this->mExtraVar.');return false;"><span class="'.$this->mPageCss.'">'.$i.'</span></a></li> ';
			}
		}
		return $rtn;
	}

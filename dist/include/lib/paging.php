...
class YsPaging {
	...
	*/
	function getFirstPage() {
		...
		return '<a href="#" onclick="go_page(1);return false;" class="btn_page_first"><strong class="ico_arr">처음</strong></a>';
	}
	...
	*/
	function getLastPage() {
		...
		return '<a href="#" onclick="go_page('.$this->mPageCount.');return false;" class="btn_page_last"><strong class="ico_arr">마지막</strong></a>';
	}
	...
	*/
	function getPrevPage() {
		if($this->mCurPageNum > 1)
			...
			return '<a href="#" onclick="go_page('.($this->mCurPageNum-1).');return false;" class="btn_page_prev"><strong class="ico_arr">이전</strong></a>';
		else
	...
	*/
	function getNextPage() {
		if($this->mCurPageNum != $this->mPageCount && $this->mPageCount)
			...
			return '<a href="#" onclick="go_page('.($this->mCurPageNum+1).');return false;" class="btn_page_next"><strong class="ico_arr">다음</strong></a>';
		else
